...
.player-view :deep(.user-pill) {
  height: var(--player-header-capsule-h);
  min-height: var(--player-header-capsule-h);
  max-height: var(--player-header-capsule-h);
  transform: none;
}

.player-view :deep(.app-header-left .nav-button.nav-button--exit) {
  height: var(--player-header-capsule-h);
  min-height: var(--player-header-capsule-h);
  max-height: var(--player-header-capsule-h);
  min-width: 8.25rem;
