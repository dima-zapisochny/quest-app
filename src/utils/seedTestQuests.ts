...
const TEST_QUEST_DEFS: TestQuestDef[] = [
  ...
  },
  {
    ...
    questions: 3,
    samples: [
      ['Автор «Лунної сонати»?', 'Людwig van Beethoven'],
      ['Інструмент з клавішами та струнами?', 'Фортепіано'],
      ['Група: «Let It Be»?', 'The Beatles'],
      ['Опера Моцарта про закоханого ловеласа?', 'Дон Жуан'],
      ['Стиль: джаз народився в …?', 'США'],
      ['Скільки струн у стандартній гітарі?', '6'],
      ['Композитор «Carmina Burana»?', 'Carl Orff'],
      ['Український бандурист — народний інструмент?', 'Бандура'],
      ['Жанр: швидкий ритм, реп-текст?', 'Хіп-хоп']
    ]
  },
  {
    ...
    samples: [
      ...
      ['Столиця Австралії?', 'Canberra'],
      ['Найвища гора світу?', 'Еверест'],
      ['Океан між Європою та Америкою?', 'Атлантичний'],
      ['Країна: піраміди Гізи?', 'Єгипет'],
